...
<body id="page-top" class="index">
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-heading">Your Pleasure is Our Treasure</div>
                <a href="#booknow" class="page-scroll btn btn-xl">Book Now</a>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Book Yours Now</h2>
                    <h3 class="section-subheading text-muted">Make a Reservation</h3>
                </div>
            </div>
            <div class="row">
            ...
            <hr>
             <div class="row">
                <form name="confirmpayment" action="confirmpayment.php" method="post">
                    <div class="col-sm-12 text-center">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    ...
                    <div class="portfolio-caption">
                        <h4>Single Bed</h4>
                        <p class="text-muted">Hotel Room</p>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/room/double.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Double Bed</h4>
                        <p class="text-muted">Hotel Room</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/room/executive.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Executive Bed</h4>
                        <p class="text-muted">Hotel Room</p>
    ...
    <!-- Team Section -->
    <section id="meeting" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Meeting Packages</h2>
            ...
            <div class="row">
                <div class="col-sm-offset-2 col-sm-4">
                    <div class="team-member">
                        <img src="img/room/meeting.jpg" class="img-responsive img-circle" alt="">
                        <h4>Half Day Package</h4>
                        <p class="text-muted">Half Day Package Description</p>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <p class="text-muted">Full Day Package Description</p>
                    </div>
                </div>
            </div>
            <div class="row">
